...
const SamsungModelScreen = () => {
  ...
  const [selectedModel, setSelectedModel] = useState('GALAXY S24')
  ...
  const handleSubmit = () => {
    actions.setPhoneSelection('samsung', selectedModel.toLowerCase().replace(/\s+/g, '-'), null)
